...
class MyPoints2View extends GetView<MyPoints2Controller> {
  const MyPoints2View({Key? key}) : super(key: key);
  @override
                      ...
                      children: [
                        Container(
                          child: Row(
                            children: [
                              Container(
                                child: Image.asset("assets/logo/tas.png"),
                              ),
                              SizedBox(width: 10),
                              Text("Daging Sapi 1 Kg"),
                            ],
                          ),
                        ),
                        Text(
                      ...
                      children: [
                        Container(
                          child: Row(
                            children: [
                              Container(
                                child: Image.asset("assets/logo/setoran.png"),
                              ),
                              SizedBox(width: 10),
                              Text("Setoran Limbah"),
                            ],
